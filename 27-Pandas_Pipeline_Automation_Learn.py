...
# ------------------------------------------------------------
df.to_csv("learn_sales_cleaned_data.csv", index=False)
high_value_orders.to_csv("learn_high_value_orders.csv", index=False)
online_sales.to_csv("learn_online_sales.csv", index=False)
city_sales.to_csv("learn_city_sales_summary.csv", index=False)
category_sales.to_csv("learn_category_sales_summary.csv", index=False)
